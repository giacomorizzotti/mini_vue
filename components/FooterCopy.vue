...
<template>
  ...
  <p v-if="props.telegram" class="S m-0"><a :href="'https://t.me/'+props.telegram" target="_blank"><Telegram width="16px" height="16px" style="vertical-align: text-bottom;" title="Telegram"  /> @{{ props.telegram }}</a></p>
